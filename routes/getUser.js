...
router.get('/', function (req, res, next) {
  //var users = [];
  var sql = 'SELECT user_info.open_id,user_info.nick_name,user_info.avatarUrl from user_info,message where user_info.open_id=message.receive_id or user_info.open_id=message.send_id GROUP BY open_id HAVING open_id!=?';
